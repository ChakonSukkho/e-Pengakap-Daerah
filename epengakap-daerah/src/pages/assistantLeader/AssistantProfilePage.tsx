...
export default function AssistantProfilePage() {
  ...
  async function addAuditLog(action: string, description: string) {
    ...
    await supabase.from("audit_logs").insert({
      actor_name: currentUser.full_name || "Penolong Pemimpin",
  ...
  async function saveProfile() {
    ...
    await addAuditLog(
      "UPDATE",
      `Kemaskini profil penolong pemimpin: ${form.full_name}`
    );
      ...
      <div className="row g-4">
        <div className="col-lg-4">
          ...
          <div className="alert alert-secondary mt-4 mb-0">
            ...
            Role ini hanya boleh melihat ahli, aktiviti dan profil sendiri.
          </div>
        </div>
